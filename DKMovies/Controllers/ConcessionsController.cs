...
namespace DKMovies.Controllers
{
    public class ConcessionsController : Controller
    {
        ...
        {
            ViewData["UnitID"] = new SelectList(_context.MeasurementUnits, "UnitID", "UnitName");
            return View();
        }
        ...
        public async Task<IActionResult> Create([Bind("ConcessionID,Name,Description,Price,StockLeft,UnitID,IsAvailable,ImagePath")] Concession concession)
        {
            ...
            ViewData["UnitID"] = new SelectList(_context.MeasurementUnits, "UnitID", "UnitName", concession.UnitID);
            return View(concession);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ConcessionID,Name,Description,Price,StockLeft,UnitID,IsAvailable,ImagePath")] Concession concession)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                {
                    if (!ConcessionExists(concession.ConcessionID))
                    {
                        return NotFound();
                    }
                    else
