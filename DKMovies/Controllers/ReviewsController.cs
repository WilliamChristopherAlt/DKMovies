...
namespace DKMovies.Controllers
{
    public class ReviewsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ReviewID,MovieID,UserID,Rating,Comment,CreatedAt,IsApproved")] Review review)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ReviewID,MovieID,UserID,Rating,Comment,CreatedAt,IsApproved")] Review review)
        {
